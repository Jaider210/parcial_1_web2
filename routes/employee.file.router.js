...
const employeeSchema = Joi.object({
    ...
    ip_address: Joi.string().forbidden()
});


// Obtener todos los empleados con filtros y límite
employeeFileRouter.get('/', (req, res) => {
...
employeeFileRouter.get('/:codigo_empleado', (req, res) => {
...
employeeFileRouter.post('/', (req, res) => {
...
employeeFileRouter.put('/:codigo_empleado', (req, res) => {
...
employeeFileRouter.put('/update-field', (req, res) => {
...
employeeFileRouter.delete('/:codigo_empleado', (req, res) => {
    const employees = readData();
    const employeeIndex = employees.findIndex(e => e.codigo_empleado === req.params.codigo_empleado);
    if (employeeIndex === -1) return res.status(404).send('Empleado no encontrado');
...
employeeFileRouter.get('/:codigo_empleado/pdf', (req, res) => {
    const employees = readData();
